...
excerpt: "Step-by-step guide to reclaiming disk space on a Windows Server 2016 Docker host — leaving swarm mode, removing stopped containers, dangling images, unused volumes, and networks."
---
